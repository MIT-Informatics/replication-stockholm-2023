...
*Describe in details if you have found coding error(s) and how they affect the main conclusions. In the event that the sign, magnitude or statistical significance is changed for the main estimates or robustness checks, report the new point estimates (e.g., in a table) in this section.g:*
...
# workaround absence of tidier for estimatr models summary
...
### Summary - Computational Reproducibility
...
-   use glm, lm fitters to check implementation robustness

-   could also use nls, bayesglm, mle2 \-- would require re-expressing current formula in different syntax
...
alt_est_m1.df <- tidy_results(list(lmrobust = results_m1_computational.lmr,
                                  lm=results_m1_statlm.lm,
                                  glm=results_m1_statglm.glm))

alt_est_m1_summary.df <- tidy_summary(list(lmrobust = results_m1_computational.lmr,
                                  lm=results_m1_statlm.lm,
                                  glm=results_m1_statglm.glm))
