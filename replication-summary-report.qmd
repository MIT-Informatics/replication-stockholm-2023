...
results_computational.lm <-
  estimatr::lm_robust(formula(paste0("d_rr_06 ~", lmspec)), data = austria.df)

tidy_computational.df <-
  broom::tidy(fit1.lm) %>% mutate(repl_id = "computational")
...
print(tidy_original.df)
print(tidy_computational.df)
summary(results_computational.lm)
